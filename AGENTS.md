...
This project is indexed by GitNexus as **tabularis** (5480 symbols, 12040 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
