...
This project is indexed by GitNexus as **tabularis** (10811 symbols, 20348 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
