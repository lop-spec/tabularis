...
const paths = {
  ...
  websiteVersion: resolve("website/src/lib/version.ts"),
...
// 5. Update website/src/lib/version.ts
const websiteVersionContent = `/**
...
`;
writeFileSync(paths.websiteVersion, websiteVersionContent);
console.log("✅ Updated website/src/lib/version.ts");
