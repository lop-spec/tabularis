...
import { QueryModal } from '../../../src/components/ui/QueryModal';
...
describe('QueryModal', () => {
  ...
  it('initializes with provided initial values', () => {
    ...
    expect(screen.getByTestId('monaco-editor')).toHaveValue('SELECT * FROM test');
  });
  ...
  it('calls onSave with correct values on valid submit', async () => {
    ...
    await waitFor(() => {
      expect(mockOnSave).toHaveBeenCalledWith('Test Query', 'SELECT * FROM users');
    });
